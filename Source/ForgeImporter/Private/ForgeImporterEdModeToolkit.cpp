			...
			[
				...
				[
					SNew(SButton)
						...
						.ToolTip(SNew(SToolTip)
							.Text(LOCTEXT("ForgeToolExport_Tip", "Exporting the current interactables to a forge map")))
				...
				[
					SNew(SButton)
						...
						.ToolTip(SNew(SToolTip)
							.Text(LOCTEXT("ForgeToolImport_Tip", "Import chosen forge map to the current level")))
						.HAlign(HAlign_Center)
						.VAlign(VAlign_Center)
